  ...
  return <div className="min-h-screen bg-gradient-to-b from-spiti-forest to-spiti-blue/30">
      ...
      <section className="relative pt-20 lg:pt-28">
        <div className="h-[40vh] md:h-[50vh] relative overflow-hidden">
          <img src="https://images.unsplash.com/photo-1531971085967-902433ecf68e?w=1600&q=80" alt="Spiti Valley Mountains" className="absolute inset-0 w-full h-full object-cover" />
