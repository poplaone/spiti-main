  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 flex flex-col-reverse md:flex-row items-center justify-between gap-8">
          ...
          <div className="w-full md:w-[400px]">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h2 className="text-2xl font-bold text-center text-spiti-dark mb-4">Get Free Tour Plan</h2>
              <LeadForm />
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
                  ...
                  {Array.from({ length: tour.duration.days }).map((_, index) => (
                    <div key={index} className="mb-4">
                      ...
                      <p className="mt-2 text-gray-600">
                        {index === 0 
                          ? "Start your journey from your pickup location and drive to your first destination." 
                          : index === tour.duration.days - 1
                          ? "After breakfast, check out from the hotel and end your journey with beautiful memories."
                          : `Explore the beautiful landscapes of ${tour.nightStays[index]?.location || "the region"} and visit local attractions.`
                        }
                      </p>
                    </div>
                  ))}
              ...
              <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-600 mb-4">Stay in comfortable accommodations throughout your journey:</p>
                <div className="space-y-2">
                  {tour.nightStays.map((stay, index) => (
                    <div key={index} className="flex items-center">
                      <Check className="text-green-500 w-5 h-5 mr-2" />
                      <span>{stay.nights} night{stay.nights > 1 ? 's' : ''} in {stay.location}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="sticky top-24 bg-gray-50 p-6 rounded-lg shadow-sm">
                <h2 className="text-2xl font-bold text-spiti-dark mb-4">Book This Tour</h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-spiti-dark">More Popular Tours</h2>
